...
setupGenSel_s2 <- function(trait=traits[1], i=1){
  for(j in 1:1){ ### change j to add more randomization 
    
    
    mysh <- paste(trait, j, "run41000_training_s2.sh", sep="_")
    
    #### add 
    for(k in 1:5){
      mypheno1 <- paste("/home/NSF-SAM-GS/HGWAS/SNPdiallel/dcv2/pheno/", trait,
                       "_", j, "_train_s", k, ".txt", sep="")
...
pwd = "/home/NSF-SAM-GS/HGWAS/SNPdiallel/dcv2/krn"
setupGenSel_s2(trait=traits[1], i=1)
pwd = "/home/NSF-SAM-GS/HGWAS/SNPdiallel/dcv2/cd"
setupGenSel_s2(trait=traits[2], i=2)
pwd = "/home/NSF-SAM-GS/HGWAS/SNPdiallel/dcv2/cl"
setupGenSel_s2(trait=traits[3], i=3)
pwd = "/home/NSF-SAM-GS/HGWAS/SNPdiallel/dcv2/cw"
setupGenSel_s2(trait=traits[4], i=4)
pwd = "/home/NSF-SAM-GS/HGWAS/SNPdiallel/dcv2/akw"
setupGenSel_s2(trait=traits[5], i=5)
pwd = "/home/NSF-SAM-GS/HGWAS/SNPdiallel/dcv2/tkw"
setupGenSel_s2(trait=traits[6], i=6)
pwd = "/home/NSF-SAM-GS/HGWAS/SNPdiallel/dcv2/kc"
setupGenSel_s2(trait=traits[7], i=7)
